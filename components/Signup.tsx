  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-[var(--bg-primary)] p-8 rounded-2xl w-full max-w-md relative border border-[var(--border-color)]">
        ...
        <h2 className="text-2xl font-black uppercase text-white mb-6">Sign Up</h2>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 bg-white text-black rounded-lg font-bold hover:bg-gray-100 transition-colors disabled:opacity-50 mb-4 flex items-center justify-center gap-3"
        >
